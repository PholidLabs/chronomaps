...
export interface ChronoTheme {
  ...
  sea: string; land: string; coast: string; river: string; lake: string;
...
export const parchmentLight: ChronoTheme = {
  ...
  sea: '#C5D1CB', land: '#ECE3CD', coast: '#7E6F58', river: '#7C9A98', lake: '#C5D1CB',
...
export const parchmentDark: ChronoTheme = {
  ...
  sea: '#101617', land: '#262520', coast: '#8F826C', river: '#4F6F6C', lake: '#101617',
